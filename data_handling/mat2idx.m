function [valueVector,yVector,xVector] = mat2idx(matrix)
	%mat2idx Transforms a matrix into a triple of indexed vectors; one
	...
	%	x-location x(i)
	%syntax: [valueVector,yVector,xVector] = mat2idx(matrix)
	%	Version history:
	%	1.0 - May 11 2011
